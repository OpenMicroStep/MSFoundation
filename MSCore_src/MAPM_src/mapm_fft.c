 ...
 *   2) removed usage of static local arrays M_aa_array and M_bb_array and int M_size so no need for M_free_all_fft().
 */
...
#define M_fft_error_msg  "\'M_fast_mul_fft\', Out of memory"
