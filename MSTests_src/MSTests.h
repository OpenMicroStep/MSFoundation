...
#define ASSERT(TEST, MSG...)            testAssert(!!(TEST), _ASSERT_VALUE(TEST), __FILE__, __LINE__, MSG)
...
#define ASSERT_ISEQUAL(A, B, MSG...)    ({ __typeof__(A) __a= (A); __typeof__(B) __b= (B); testAssert(ISEQUAL(__a, __b), "ISEQUAL("#A", "#B") => " _ASSERT_VALUE(ISEQUAL(A, B)), __FILE__, __LINE__, MSG, __a, __b); })
#define ASSERT_ISNOTEQUAL(A, B, MSG...) ({ __typeof__(A) __a= (A); __typeof__(B) __b= (B); testAssert(!ISEQUAL(__a, __b), "!ISEQUAL("#A", "#B") => " _ASSERT_VALUE(!ISEQUAL(A, B)), __FILE__, __LINE__, MSG, __a, __b); })
