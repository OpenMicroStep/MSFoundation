...
//typedef struct Module Module; conflict with objc-runtime.h -> renamed in SQLCipherModule
typedef struct SQLCipherModule SQLCipherModule;
...
** hash table.
*/
struct SQLCipherModule { //original name Module
...
struct VTable {
  ...
  SQLCipherModule *pMod;             /* Pointer to module implementation */
