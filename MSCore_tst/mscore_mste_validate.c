...
//printf("B0: %s\n",ssrc);
  ...
  if (error) {
    ke= (id)CSCreate("error");
    kd= (id)CSCreate("description");
...
//["MSTE0101",9,"CRCc8e768a6",1,"FirstClass",1,"OneKey",4,"Json \\a\/b\"c\u00C6"]
  ...
  o1= (id)CSCreate("Æ?"); // Badly-formed last character
